...
import { setQuestion, setQuestions, addQuestion, updateQuestion, addChoice, deleteChoiceById, resetQuestion, updateCorrectById} from "../questionsReducer";
...
function FillInTheBlank () {
  ...
  return (
    <div className = "flex">
      ...
      {question.correct.map((correct : any, index: any) => {
        return (
          <>
            <br />
            <div className = "row">
              ...
              <div className = "col-7">
                <input type = "text" className = "form-control w-25" id = {index.toString()} value = {correct} onChange = { (e) => dispatch(updateCorrectById({ index: index, correct: e.target.value }))}/>
              </div>
