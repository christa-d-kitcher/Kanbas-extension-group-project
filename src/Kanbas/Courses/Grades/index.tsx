    ...
    <div className="my-5 me-3">
      <div>
        <div className="header d-flex flex-row-reverse">
          ...
          <button
            className="btn btn-light btn-outline-dark mx-2 dropdown-toggle"
            data-bs-toggle="dropdown"
          >
            <MdOutlineOutput /> Export
          </button>
        ...
        <button className="btn btn-light btn-outline-dark my-4">
      ...
      <div className="table-responsive">
        <table className="table table-striped table-hover text-center table-bordered">
          <thead>
            ...
            {as.map(assignment => (
              <th className="py-2 border-1">{assignment.title}</th>
            ))}
          </thead>
          <tbody>
            {es.map(enrollment => {
