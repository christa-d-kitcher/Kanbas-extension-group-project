    ...
    <div className="RightPart float-start mt-4 pt-2 d-none d-lg-block">
      ...
      <div className="course-status me-4">
        ...
        <div className="btn-roup mb-2">
          <button
            type="button"
            className="btn btn-light btn-outline-dark right-button__Unpublish"
            style={{ fontSize: '15px' }}
          >
          ...
          <button
            type="button"
            className="btn btn-success btn-outline-dark right-button__Published"
            style={{ fontSize: '15px' }}
          >
        ...
        <div className="btn-group-vertical">
          ...
          <button className="btn btn-light btn-outline-secondary mb-1">
            <a
              href="/"
              className="text-decoration-none text-muted align-items-center d-flex"
              style={{ fontSize: '15px' }}
            >
              <LuFileInput />
      ...
      <div className="to-do mt-3 me-3">
        ...
        <div className="to-do-message clearfix">
          ...
          <span className="float-start ms-2 message">
      ...
      <div className="coming-up mt-4 clearfix me-3">
        <h5>Coming Up</h5>
        <a href="/" className="float-end text-danger text-decoration-none mt-2">
          <SlCalender /> View Calendar
        </a>
        <br />
        <hr />
        <div className="coming-up-message clearfix">
          ...
          <span className="text-danger float-start message">
            Lecture <br />
            <small className="text-secondary">CS4550.12631.202410</small>
            <br />
        ...
        <div className="coming-up-message mt-3 clearfix">
          ...
          <span className="text-danger float-start message">
            CS5610 06 SP23 Lecture <br />
            <small className="text-secondary">CS5610.12631.202410</small>
            <br />
            <small className="text-secondary">Sep 11 at 11:45am</small>
          </span>
          <i className="fas fa-times float-end" />
        ...
        <div className="more-message mt-3">
          <span>
            <a href="/" className="text-danger text-decoration-none message">
